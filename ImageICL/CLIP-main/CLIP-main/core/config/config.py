...
class Config(object):
    ...
    def _load_console_dict():
        ...
        parser.add_argument("-tw", "--test_way", type=int, help="test way num")
        parser.add_argument("-ts", "--test_shot", type=int, help="test shot num")
        ...
        parser.add_argument("-n_gpu",  "--n_gpu", type=int, help="gpu num")
        ...
        parser.add_argument("-test_folds", "--test_folds", type=str, help="fold number for cross-validation evaluation")
        parser.add_argument("-experiment_dir", "--experiment_dir", type=str, help="folder to store experiments")
        parser.add_argument("-fixed_classes", "--fixed_classes", type=int, help="experimental argument")
        parser.add_argument("-stability_test", "--stability_test", type=str, help="experimental argument for the stability measure")
        parser.add_argument("-test_batch", "--test_batch", type=int, help="experimental argument for the batched test")
        parser.add_argument("-boot_seed", "--boot_seed", type=int, help="bootstrapping evaluator seed")
        parser.add_argument("-eval_types", "--eval_types", type=str, help="evaluators")
    ...
    def _merge_config_dict(self):
        ...
        # eval configs
        if not self.is_resume:
            if config_dict.get('test_folds') is not None:
                config_dict['test_folds'] = config_dict['test_folds'].replace(' ', '').split(',')
