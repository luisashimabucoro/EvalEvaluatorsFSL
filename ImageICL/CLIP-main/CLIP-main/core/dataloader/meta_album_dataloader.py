...
class MetaAlbumDataset(Dataset):
    ...
    def __init__(self, datasets, data_dir, img_size=224, info="labels"):
        if len(datasets) == 1: 
        ...
        for dataset in datasets:
            ...
            (label_col, file_col, 
            img_path, md_path) = self.extract_info(dataset, info)
            ...
            # print(id_to_label)
            with open(f'/home/s2589574/BEPE/EmbeddingFSL/CLIP-main/CLIP-main/data/{datasets[0]}.pickle', 'wb') as handle:
    ...
    def extract_info(self, dataset, info="labels"):
        info = {"img_path": f"{self.data_dir}/{dataset}/images/",
            "metadata_path": f"{self.data_dir}/{dataset}/{info}.csv",
            "label_col": "CATEGORY",
            "file_col": "FILE_NAME"}
