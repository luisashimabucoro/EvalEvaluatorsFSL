...
def load_fromage(model_dir: str) -> Fromage:
  ...
  logit_scale = model.model.logit_scale.exp().to(dtype=torch.float16)
  emb_matrix = torch.tensor(emb_matrix, dtype=torch.float16).to(logit_scale.device)
  print(emb_matrix.dtype)
